...
![time_taken](https://img.shields.io/badge/Time%20Taken-6.5%20hours-red)
...
- In this project, I Design Product Home Page.

- I learned how to use z-index property.

- I learned, border-radius property for buttons.

- I learned, How to use svg file in project.

- I Learned, about flex-box property.

- I Learned, about position property (relative and absolute).
